...
const AddCourtPage = () => {
   ...
   return (
      <div className="p-8 w-auto mx-auto text-black  shadow-md space-y-4">
         <h2 className="text-4xl font-black  border-b-2 border-blackberry-color text-center p-4">
            Add My Court
         </h2>
         <form onSubmit={submitHandler}>
            <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-6">
               ...
               <div>
                  <label className="mb-2 text-xl block ">
                  ...
                  {timings.map((timing, index) => (
                     ...
                     >
                        <div className="  sm:block">
                           <h1 className="mr-4 text-black  text-xl h-4">
                              {timing.day}
                           </h1>
